...
return [
    ...
    'actions' => [
        ...
        'save_draft_confirmation' => [
            'heading' => 'Сохранить как черновик?',
            'description' => 'Черновик не выставлен и не учитывается в отображаемом лимите оборота, пока вы его не выставите.',
            'submit' => 'Сохранить как черновик',
        ],
    ],
